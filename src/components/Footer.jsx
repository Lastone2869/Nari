    ...
    <footer className="border-t border-white/5 mt-20 py-10 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={to}>
                  <Link to={to} className="text-gray-500 hover:text-violet-400 text-sm transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="text-white font-semibold mb-3 text-sm uppercase tracking-wider">Emergency</h4>
            <ul className="space-y-2">
              {[
                ...
                <li key={num} className="flex items-center justify-between">
                  ...
                  <a href={`tel:${num}`} className="text-red-400 font-bold text-sm hover:text-red-300 transition-colors">
                    {num}
                  </a>
                </li>
              ))}
        ...
        <div className="border-t border-white/5 pt-6 flex flex-col md:flex-row items-center justify-between gap-2">
          ...
          <p className="text-gray-600 text-xs flex items-center gap-1">
            Made with <Heart size={11} className="text-pink-500" /> for safer communities
          </p>
        </div>
      </div>
    </footer>
